...
class Build {
    ...
    lint() {
	    ...
	    // return helpers.buildPromiseFromStream(gulp.src('app/**/*.ts server/app.ts'))
        //     .pipe(tslint())
    ...
    runWebpack() {
        ...
        return helpers.shellExec("node node_modules/webpack/bin/webpack.js --config ./build/webpack.dev.js");
    }
